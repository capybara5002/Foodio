...
namespace Foodio.API.Migrations
{
    ...
    [Migration("20260623061502_AddSavedPlaces")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Foodio.API.Models.PaymentSession", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
            ...
            modelBuilder.Entity("Foodio.API.Models.Review", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("OwnerReplyCreatedAt")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("Foodio.API.Models.SavedPlace", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(64)
                        .HasColumnType("nvarchar(64)");
            ...
            modelBuilder.Entity("Foodio.API.Models.SavedPlace", b =>
                {
                    ...
                    b.HasOne("Foodio.API.Models.User", "User")
                        .WithMany()
